...
function setupEventListeners() {
    ...
    if (searchInput && searchSuggestions) {
        ...
        const quickSuggestions = [
            'laptop', 'laptop lenovo', 'laptops', 'laptop gamer', 
            'laptop tactil', 'laptop i7', 'laptop legion', 'laptop gamer lenovo',
            'iphone', 'samsung', 'tablet', 'airpods', 'macbook'
        ];
    ...
    function showSuggestions(searchTerm) {
        ...
        // Filtrar sugerencias rápidas
        const quickSuggestions = [
            'laptop', 'laptop lenovo', 'laptops', 'laptop gamer', 
            'laptop tactil', 'laptop i7', 'laptop legion', 'laptop gamer lenovo',
            'samsung', 'tablet', 'airpods', 'macbook'
        ].filter(suggestion => 
        ...
        // Productos coincidentes (sin header)
                    ...
                    <div class="suggestion-item" onclick="selectProduct(${product.id})">
                        ...
                        <div class="suggestion-content">
                            ...
                            <div class="suggestion-rating">
                                ...
                                <span class="rating-text">4.5 (127)</span>
                            </div>
                        </div>
                    </div>
                `;
        ...
        // Sugerencias rápidas (sin header "Sugerencias")
        if (quickSuggestions.length > 0) {
            suggestionsHTML += '<div class="quick-suggestions">';
            quickSuggestions.forEach(suggestion => {
                suggestionsHTML += `
                    <span class="quick-suggestion" onclick="searchFor('${suggestion}')">${suggestion}</span>
                `;
            });
            suggestionsHTML += '</div>';
        }
...
// Funciones globales para sugerencias de búsqueda
function showSuggestions(searchTerm) {
    const searchSuggestions = document.getElementById('searchSuggestions');
    if (!searchSuggestions) return;
